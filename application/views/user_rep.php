                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="navbar navbar-inner block-header">
                                ...
                                <a href="<?php echo base_url();?>index.php/user_report/user_repo" button class="btn" style="align:right"><i class="icon-download"></i>Download</button></a>
							
                                
                                 </div>
								<h3 style='text-align:center;'>Leo Venturi Investments</h3>
								<h5 style='text-align:center;'>Payments Report as at:&nbsp<?php echo date('Y-m-d');?> </h5>
								<h6 style='text-align:center;'><?php echo $this->session->userdata('first_name');?>&nbsp<?php echo $this->session->userdata('last_name');?> </h6>
								<div class="row-fluid">
                        <!-- block -->
