...
<?php echo form_open_multipart('reg/userreg');?>
	        	<ul class="tabs">
			        <li>
	...
	<div class="control-group">
							...
							<option>Member Designation</option>
							<option value="1">Management Staff</option>
			                <option value="0">Regular Member</option>
			                
			               
			              </select>
                      <?php echo form_error('role','<div class="alert alert-error"><p>', '</p></div>');?>						  
						  </div>
						  </div>
																...
																<div class="fileupload fileupload-new" data-provides="fileupload">
                                                                                        <div class="fileupload-new thumbnail" style="width: 100px; height: 100px;">
                                                                                                <img src="http://leo-venturi.chamasoft.com/templates/admin_themes/metronic/img/profile/profile.jpg"  alt="http://leo-venturi">                                                                                        </div>
                                                                                        <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 100px; max-height: 100px; line-height: 20px;"></div>
                                                                                        <div>
                                                                                                <span class="btn btn-file"><span class="fileupload-new">Select image</span>
                                                                                                        <span class="fileupload-exists">Change</span>
																			                    <input type="file" name="userfile"   id="userfile"  class=" span6 m-wrap" />
