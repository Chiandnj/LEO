<!-- block -->
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">New Bank Account</div>
                                    <div class="pull-right">
									<a href="add_bank.html"><i class="icon-plus-sign"></i> New Bank Account  </a>
									<a href="bank_list.html"><i class="icon-list"></i> List  </a>
									
									<a href="bank_statements.html"><i class="icon-list-alt"></i> Statements  </a>
									<a href="payment_tables.html"><i class="icon-download-alt"></i>  Export</a>
...
<option value="Victoria Commercial Bank">Victoria Commercial Bank</option>
						 ...
						 <div class="control-group">
                                                                                            <label class="control-label"><strong>Date Opened</strong></label>
                                                                                            <div class="controls">
                                                                                               <!--Date -->
						...
						<div class="control-group">
						  ...
						  <div class="controls">
						       <input type="text" name="account_name"  id="account_name"value="<?php echo set_value('account_name'); ?>"><?php echo form_error('account_name','<div class="alert alert-info"><p>', '</p></div>');?>						  </div>
						 </div>
						 
						<div class="control-group">
						  <label class="control-label"><strong>Account Number</strong></label>
						  <div class="controls">
						        <input type="text" name="account_no" id="account_no" value="<?php echo set_value('account_no'); ?>"><?php echo form_error('account_no','<div class="alert alert-info"><p>', '</p></div>');?>						  </div>
						 </div>
						 
						<div class="control-group">
						  <label class="control-label"><strong>Initial Balance (KES)</strong></label>
						  <div class="controls">
						          <input type="text" name="balance" id="balance" value="<?php echo set_value('balance'); ?>"><?php echo form_error('balance','<div class="alert alert-info"><p>', '</p></div>');?>						  </div>
						 </div>
						 
						<div class="control-group">
						  <label class="control-label"><strong>Branch Name</strong></label>
						  <div class="controls">
						        <input type="text" name="branch"  id="branch" value="<?php echo set_value('branch'); ?>"><?php echo form_error('branch','<div class="alert alert-info"><p>', '</p></div>');?>						  </div>
						 </div>
								 <div class="control-group">
								  <label class="control-label"><strong>Reasons</strong></label>
								  <div class="controls">
								 <input type="text" class="input-xlarge" id="reasons" name="reasons" value="<?php echo set_value('reasons'); ?>"><?php echo form_error('reasons','<div class="alert alert-info"><p>', '</p></div>');?>								
								  </div>
							   </div>  	   
