                            ...
                            <div class="block">
								...
								<div class="span6">
								<?php echo form_open('lipa/pesa');?>
								<input type="hidden" name="type" value="MERCHANT" readonly="readonly" />
								<input type="hidden" name="reference" value="<?php echo(rand(1,100000));?>"/>
	...
	<input class="input-xlarge disabled" id="disabledInput" type="text" class="input" name="first_name"  value="<?php echo $this->session->userdata('first_name');?>">                                                                 
	</div>
	</div>
															<div class="control-group">
	...
	<input class="input-xlarge disabled" id="disabledInput" type="text" class="input"  name="last_name"  value="<?php echo $this->session->userdata('last_name');?>">                                                                      
	</div>
	</div>
	...
	<input class="input-xlarge disabled" id="disabledInput" type="text" class="input" name="email"  value="<?php echo $this->session->userdata('email');?>">                                                                   
	</div>
	</div>
							...
							<div class="controls">
								<textarea name="description" cols="60" rows="5"  class="auto  span6 m-wrap" value="<?php echo set_value('description'); ?>"> </textarea>							</div>
						</div>
